...
// DIAGNOSTICO TEMPORAL (tearing Android tablet): sacado para probar si el
// boton "Agregar" en cada tarjeta es la causa. Revertir despues de probar.
...
export function ProductResultCard({
  ...
  const actions = (
    <div className="mt-3 flex items-center gap-4 border-t border-border pt-3">
      ...
      {/* DIAGNOSTICO TEMPORAL: <AddToCartButton product={product} /> */}
    </div>
  );
